...
{
    public partial class View_Stock_General : Form
    {
        ...
        private void View_Stock_General_Load(object sender, EventArgs e)
        {
            BindGridView();
            GridViewDimensions();
            populateInsert();
        ...
        private Boolean findDuplicate(String title, String date, int index)
        {
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                if (i != index && dataGridView1.Rows[i].Cells[1].Value != null && dataGridView1.Rows[i].Cells[2].Value != null)
                {
        ...
        private void colorDuplicates()
        {
            ...
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                if (dataGridView1.Rows[i].Cells[1].Value != null && dataGridView1.Rows[i].Cells[2].Value != null)
                {
                    String currTitle = dataGridView1.Rows[i].Cells[1].Value.ToString();
                    String currDate = dataGridView1.Rows[i].Cells[2].Value.ToString();
                    if (findDuplicate(currTitle, currDate, i))
                    {
        ...
        {
            String query = "SELECT Stock_ID AS [ID], Title, Date, Unit, Catergory, Sub_Catergory " +
        ...
        private void getScales()
        {
            ...
            String query = "SELECT Stock_ID AS [ID], Title, Date, Unit, Catergory, Sub_Catergory, CONCAT(Scales.Limit, Scales.Limit_Unit) AS [Weight Limit], CONCAT(Scales.Dimension_Length, Scales.Dimension_Opperator, Scales.Dimension_Width) AS [Dimensions], is_Water_Proof " +
        ...
        {
            String query = "SELECT Stock_ID AS [ID], Title, Date, Unit, Catergory, Sub_Catergory, CONCAT(Loadcells.L_Mass, Loadcells.L_Mass_Unit) AS [Loadcell Limit]" +
        ...
        {
            String query = "SELECT Stock_ID AS [ID], Title, Date, Unit, Catergory, Sub_Catergory, CONCAT(Weights.W_Mass, Weights.W_Mass_Unit) AS [Weight] " +
        ...
        {
            String query = "SELECT Stock_ID AS [ID], Title, Date, Unit, Catergory, Sub_Catergory, CONCAT(Weight_Sets.MinMass, Weight_Sets.WS_Min_Mass_Unit, Weight_Sets.WS_Opperator, Weight_Sets.MinMass, Weight_Sets.WS_Max_Mass_Unit) AS [Set Range] " +
        ...
        {
            String query = "SELECT Stock_ID AS [ID], Title, Date, Unit, Catergory, Sub_Catergory, Misc.Added_Info " +
        ...
        {
            String query = "SELECT Stock_ID AS [ID], Title, Date, Unit, Price_Each AS [Price], Catergory, Sub_Catergory, Unit*Price_Each AS [Price Total] " +
                           "FROM [Stock_Main] " +
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            string titleQuery = "SELECT Stock_ID AS [ID], Title, Date, Unit, Price_Each AS [Price], Catergory, Sub_Catergory, Unit*Price_Each AS [Price Total] " +
